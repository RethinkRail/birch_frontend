...
const BillingEfficiencyChart = ({ startDate, endDate, dateDiff, dataSet,name }) => {
    console.log(dataSet)
    ...
    const uniqueNames = [...new Set(dataSet.map((item) => item.railcar_id))];
    ...
    const options = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: `Billing Efficiency From ${new Date(startDate).toLocaleDateString()} To ${new Date(
                    endDate
...
export default BillingEfficiencyChart;
