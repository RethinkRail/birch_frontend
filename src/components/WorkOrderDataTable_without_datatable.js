        ...
        <React.Fragment>
            <div className="overflow-x-hidden w-full mx-auto  mt-[-1px] text-[14px] font-medium">
                ...
                <div className="overflow-x-hidden w-full mt-[20px] ml-[1px] mx-auto border rounded-[8px] mb-10">
                    <table className="overflow-x-hidden border-y py-[12px]   w-full  bg-white   text-[#686868]"
                           ref={tableRef}>
                        ...
                        <tr className='h-[44px]'>
                            ...
                            <th className="h-[44px] p-0  items-center">
                                <div className="flex items-center cursor-pointer justify-between">DIF</div>
                            </th>
                            <th className="h-[44px]  p-5 flex items-center cursor-pointer justify-between pl-[1px]">CAR</th>
                            <th className="h-[44px]  w-[81px] ">
                                <div className="flex items-center cursor-pointer justify-between">ARR. DATE</div>
                            </th>
                        ...
                        {modifiedWorkOrder.map((wo, index) => (
                            <tr key={index}
                                className={`text-[12px] py-[20px] align-middle  uppercase font-medium  ${index % 2 === 1 ? 'bg-[#F5F9FF]' : ''}`}>
...
const CustomDateInput = ({value, onClick}) => (
    <div className="w-fit mx-auto">
        <div onClick={onClick}
             className='flex items-center justify-between  border  rounded-[4px] w-[116px] whitespace-nowrap overflow-hidden h-[32px] '>
