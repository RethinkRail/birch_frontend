...
const Navbar = () => {
    ...
    const active_class = "bg-white hover:bg-[#efefef] text-[#002E54] py-2 px-3 h-[40px] my-auto flex mt-[px] pt-[9px] rounded-[6px]"
    const in_active_class = "py-2 hover:bg-[#1116]  text-[#F2F4F7] px-3 rounded-[6px] flex items-center h-[40px] "
    const navebarItems =
        <>
            <NavLink className={({ isActive }) => isActive ? active_class : in_active_class} to="/Work-Order">Work Order</NavLink>
        ...
        <div className={`w-full p-0  mx-auto ${(isHovered || isHovered2) && "mb-[64px]"}`}>
            ...
            {isHovered &&
                <ul
                    ...
                    onMouseLeave={() => setHovered(false)}
                    className={`bg-[#002E54] py-[12px] px-[32px]  border-t-[1px] border-gray-600 items-center  flex justify-center gap-[12px]  h-[64px] text-white absolute opacity-0 whitespace-nowrap w-[1440px] transform transition-all duration-300 ${isHovered ? 'opacity-100 scale-100' : 'scale-0'}`}>
...

            {
                ...
                <ul
                    ...
                    onMouseLeave={() => setHovered2(false)}
                    className={`bg-[#002E54] py-[12px] px-[32px]  items-center gap-[12px] border-t-[1px] border-gray-600  text-white absolute h-[64px] opacity-0 whitespace-nowrap flex justify-center w-[1440px] transform transition-all duration-300 ${isHovered2 ? 'opacity-100 scale-100' : 'scale-0'}`}>
