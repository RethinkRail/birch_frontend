    ...
    return (
        <div className="overflow-x-auto w-full mt-[26px] mx-auto border rounded-[8px]">
            <table className="  mx-auto   w-full font-inter bg-white  text-[#686868] font-semibold">
                ...
                <tr>
                    <th className="bg-[#DCE5FF] px-[24px] w-[360px] text-left  h-[46px]  whitespace-nowrap rounded-l ">Car
                        Number
                    </th>
                    <th className="bg-[#DCE5FF] px-[24px] w-[383px] text-left  h-[46px] whitespace-nowrap   ">Task</th>
                    <th className="bg-[#DCE5FF] px-[24px] w-[308px] text-left  h-[46px] whitespace-nowrap  ">Time
                        Duration
                    </th>
                    <th className="bg-[#DCE5FF] px-[24px] w-[308px] text-center h-[46px] whitespace-nowrap   rounded-r ">MARK
                        AS COMPLETE
                    </th>
                </tr>
                </thead>
                ...
                {modifyedTasks.map((task, index) => (
                    <tr key={index}
                        className={` h-[71px] ${index % 2 === 1 ? 'bg-[#F7F9FF] text-[] border-y' : 'border-t'}`}>
