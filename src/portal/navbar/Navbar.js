        ...
        <>
            ...
            >
                ...
                {isHoveredPrimary && (
                    ...
                    >
                        <NavLink className={({ isActive }) => isActive ? active_class : in_active_class} to="/sublink1" onClick={() => setIsHoveredPrimary(false)}>submenu 1</NavLink>
                        <NavLink className={({ isActive }) => isActive ? active_class : in_active_class} to="/sublink2" onClick={() => setIsHoveredPrimary(false)}>submenu 2</NavLink>
                        <NavLink className={({ isActive }) => isActive ? active_class : in_active_class} to="/sublink3" onClick={() => setIsHoveredPrimary(false)}>submenu 3</NavLink>
                        <NavLink className={({ isActive }) => isActive ? active_class : in_active_class} to="/sublink4" onClick={() => setIsHoveredPrimary(false)}>submenu 4</NavLink>
                    </ul>
                )}
            </div>
        </>
